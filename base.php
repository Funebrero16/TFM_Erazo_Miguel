    ...
    <body>
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse  collapse">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#works"><strong>Bienvenido <?php echo $_SESSION['usuario'] ?></strong></a></li>
        ...
        <div id="works"  class=" clearfix grid"> 
            <figure class="effect-oscar  wowload fadeIn">
                ...
                <figcaption>
                    <h2>Renal</h2>
                    <p><br><a href="renal.php">Ver Productos Nuevos</a></p>                      
                </figcaption>
            </figure>
            <figure class="effect-oscar  wowload fadeInUp">
                ...
                <figcaption>
                    <h2>Hospitalaria</h2>
                    <p><br><a href="">Ver Productos Nuevos</a></p>               
                </figcaption>
            </figure>
            <figure class="effect-oscar  wowload fadeInUp">
